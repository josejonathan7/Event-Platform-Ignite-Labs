		...
		<div className="flex-1">
			...
			<div className="p-8 max-w-[1100px] mx-auto ">
							...
							data.lesson.teacher && (
								<div className="flex items-center gap-4 mt-6">
									...
									<div>
										...
										<span className="text-gray-200 text-sm block leading-relaxed">
				...
				<div className="gap-8 mt-20 grid grid-cols-2">
					<a
						href=""
						className="overflow-hidden rounded bg-gray-700 flex items-stretch gap-6 hover:bg-gray-600 transition-colors"
					>
